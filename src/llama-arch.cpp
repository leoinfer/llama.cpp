...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_NEXTN_FC_EMBEDDING,                     "nextn.fc_embedding" },
    { LLM_TENSOR_NEXTN_FC_HIDDEN,                        "nextn.fc_hidden" },
    { LLM_TENSOR_NEXTN_PRE_FC_NORM_EMBEDDING,            "nextn.pre_fc_norm_embedding" },
    { LLM_TENSOR_NEXTN_PRE_FC_NORM_HIDDEN,               "nextn.pre_fc_norm_hidden" },
    { LLM_TENSOR_NEXTN_HC_MIXER_NORM,                    "nextn.hc_mixer_norm" },
    { LLM_TENSOR_NEXTN_HC_MIXER_DOWN,                    "nextn.hc_mixer_down" },
    { LLM_TENSOR_NEXTN_HC_MIXER_UP,                      "nextn.hc_mixer_up" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // qwen4exp MTP head tensors: OUTER (no block index), so LAYER_OUTPUT
    {LLM_TENSOR_NEXTN_FC_EMBEDDING,         {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NEXTN_FC_HIDDEN,            {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NEXTN_PRE_FC_NORM_EMBEDDING,{LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_NEXTN_PRE_FC_NORM_HIDDEN,   {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_NEXTN_HC_MIXER_NORM,        {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_NEXTN_HC_MIXER_DOWN,        {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NEXTN_HC_MIXER_UP,          {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},
    // Nemotron 3 Super
