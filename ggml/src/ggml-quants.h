...
GGML_API void quantize_row_d32a3_ref  (const float * GGML_RESTRICT x, block_d32a3 * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_d32a3    (const block_d32a3 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_d32a3        (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
// R4X MIX34 (v1.g) --------------------------------------------------------------------
GGML_API void   quantize_row_mix34_ref (const float * GGML_RESTRICT x, block_mix34 * GGML_RESTRICT y, int64_t k);
GGML_API void   dequantize_row_mix34   (const block_mix34 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_mix34         (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
